...
local functions_list = {
    ...
    { name = 'polini', arguments = { { name = 'maxdeg', type = 'int' } }, returnType = 'void' },
    { name = 'polprt', arguments = { { name = 'a[]', type = 'fract' }, { name = 'na', type = 'int' }, { name = 'd', type = 'int' } }, returnType = 'void' },
    { name = 'polclr', arguments = { { name = 'a[]', type = 'fract' }, { name = 'n', type = 'int' } }, returnType = 'void' },
    { name = 'polmov', arguments = { { name = 'a[]', type = 'fract' }, { name = 'na', type = 'int' }, { name = 'b[]', type = 'fract' } }, returnType = 'void' },
    { name = 'polmul', arguments = { { name = 'a[]', type = 'fract' }, { name = 'na', type = 'int' }, { name = 'b[]', type = 'fract' }, { name = 'nb', type = 'int' }, { name = 'c[]', type = 'fract' } }, returnType = 'void' },
    { name = 'poladd', arguments = { { name = 'a[]', type = 'fract' }, { name = 'na', type = 'int' }, { name = 'b[]', type = 'fract' }, { name = 'nb', type = 'int' }, { name = 'c[]', type = 'fract' } }, returnType = 'void' },
    { name = 'polsub', arguments = { { name = 'a[]', type = 'fract' }, { name = 'na', type = 'int' }, { name = 'b[]', type = 'fract' }, { name = 'nb', type = 'int' }, { name = 'c[]', type = 'fract' } }, returnType = 'void' },
    { name = 'poldiv', arguments = { { name = 'a[]', type = 'fract' }, { name = 'na', type = 'int' }, { name = 'b[]', type = 'fract' }, { name = 'nb', type = 'int' }, { name = 'c[]', type = 'fract' } }, returnType = 'int' },
    { name = 'polsbt', arguments = { { name = 'a[]', type = 'fract' }, { name = 'na', type = 'int' }, { name = 'b[]', type = 'fract' }, { name = 'nb', type = 'int' }, { name = 'c[]', type = 'fract' } }, returnType = 'void' },
    { name = 'poleva', arguments = { { name = 'a[]', type = 'fract' }, { name = 'na', type = 'int' }, { name = 'x', type = 'fract *' }, { name = 's', type = 'fract *' } }, returnType = 'void' },
    { name = 'revers', arguments = { { name = 'y[]', type = 'double' }, { name = 'x[]', type = 'double' }, { name = 'n', type = 'int' } }, returnType = 'void' },
